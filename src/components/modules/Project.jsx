...
function Project({ data: { title, subtitle, description, imgURL, link } }) {
  return (
    <div className='p-2 bg-gray-50 shadow-sm shadow-gray-300 rounded-xl w-full'>
      ...
      <a href={link} className='px-4 py-2 mt-2 text-center bg-primary drop-shadow-sm drop-shadow-primary block text-white rounded-lg'>Open</a>
    </div>
  )
}
